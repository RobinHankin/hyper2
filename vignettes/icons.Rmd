...
The likelihood function above is mathematically identical to that used in the
hyperdirichlet package, but the terms might appear in a different order.  The first step is to find the maximum
