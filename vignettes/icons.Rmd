...
This short document analyses the climate change dataset of @oneill2008
and discussed in the `hyperdirichlet` R package [@hankin2009], but
using the improved `hyper2` package instead.  Lay perception of
climate change is a complex and interesting process [@oneill2009] and
here we assess the engagement of non-experts by the use of "icons"
(this word is standard in this context.  An icon is a "representative
...
("E" for equal).  This was not carried out in @hankin2009, because I
...
Following the analysis in @hankin2009, and restated above, we first
...
So the evaluate is at the boundary, for $p_4=p_5$.
