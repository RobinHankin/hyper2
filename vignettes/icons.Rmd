...
Software*, 33:11] but using the improved `hyper2` package instead.
Lay perception of climate change is a complex and interesting
process^[S. J. O'Neill 2008 "An iconic approach to communicating
climate change".  PhD thesis, School of Environmental Sciences,
University of East Anglia, UK] and here we assess the engagement of
...
Here we analyse results of one experiment^[S. J. O'Neill and M. Hulme
2009. "An Iconic Approach to Representing Climate Change", _Global
Environmental Change_ 19:402-410], in which subjects were presented
...
identical to `icons` object in the `hyperdirichlet` package (and
