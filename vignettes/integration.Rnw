...
The likelihood ratio reported was about 2.608, which would correspond
to a $p$-value of about 

<<>>=
pchisq(2*2.608,df=1,lower.tail=FALSE)
@ 

which would be comparable strength of evidence.  For reference, the
