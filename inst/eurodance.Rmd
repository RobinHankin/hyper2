...
The file `eurodance_2008.txt`, used below, is copied from
...
```{r, specifymatrix}
eurodance_table <- as.matrix(read.table("eurovision_dance_2008.txt"))
eurodance_table
...
Note the dominance of Poland.  Now we consider the jury's vote:
