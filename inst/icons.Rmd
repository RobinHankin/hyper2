...
@hankin2017_rmd.  This minimal document reads file `icons.txt` and
creates R objects `icons`, `icons_matrix`, and `icons_maxp`.  The
dataset is discussed extensively in @west2008 and @hankin2010; in
addition to this file, there is a more discursive vignette which may
be viewed by typing `vignette("icons")` at the command line.
