...
We can translate these into package idiom with
function `pwa()` ("person with advantage"):
...
The above suggesting that the training had a sizable effect; and we
may test the null that the training had no effect:
