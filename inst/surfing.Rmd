...
participation and viewing.  Competitive surfing involves surfers
competing against one or two other surfers in heats lasting 30-50
minutes.  Points are awarded on a 10-point scale: each of five judges
awards points to a surfer riding a particular wave.  The World Surf
League (WSL) is the main governing body of surfing competitions.  The
WSL conducts a world tour in which the best ranked 34 surfers compete;
in addition, at each tour venue, two "wildcard" surfers also enter the
competition, who are ignored here.  The 2019 WSL tour saw competitive
events held at eleven different surf locations.
...
surfer based on a range of subjective criteria including commitment
and degree of difficulty, innovation and variety of manoeuvres, and
transition between manoeuvres.  The top score and bottom score among
the five judges are removed and the remaining three judges' scores are
...
terminology of [@johnson2020].  A slight generalization allows the
...
use a technique due to Hankin (2010, 2017) and introduce
...
account for (e.g.) wet conditions in Formula 1.  


# Literature Review and previous work

Most previous research into competitive surfing is limited to the
scoring of ariel manoeuvres compared with other manoeuvres in events
[10] and analysis in the difference in average wave scores for the top
10 and bottom 10 surfers using a One-way ANOVA method [11].
