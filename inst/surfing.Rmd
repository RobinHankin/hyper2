...
p <- seq(from=0.0005,to=0.01,by=0.0005)
...
for(v in o){
   ...
   if(numberretained > 1){
     r <- r[!(r %in% remove)]
     ## Now add a compatriot monster if needed

     if(numberretained ==3){
       nationalities <- c(nationality(r[1]),nationality(r[2]),nationality(r[3]))
       if(length(unique(nationalities)) == 2){
         print(nationalities)
         if(sum(nationality(r[1]) %in% nationalities) == 1){
           Hjj <- pwa(race(r),pwa=r[1])
	   print("a")
	   print(r)
	   print(nationalities)
	   print(Hjj)
         } else if(sum(nationality(r[2]) %in% nationalities) == 1){
           Hjj <- pwa(race(r),pwa=r[2])
	   print("b")
	   print(r)
	   print(nationalities)
	   print(Hjj)
         } else if(sum(nationality(r[3]) %in% nationalities) == 1){
