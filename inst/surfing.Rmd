...
perform equally well on all types of beaches.
...
braz <- c(0.0003,0.0005,0.0008, 0.001,0.002,0.005,0.01,0.02,0.03,0.05)
...
plot(M[,2],M[,3]-max(M[,3]),type='b')
plot(M[,2],M[,3]-max(M[,3]),type='b',ylim=c(-0.3,0))
```
