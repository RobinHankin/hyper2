...
\Abstract{ 
  ...
  drawn from the fields of food preference and the e-sport {\em
    Counterstrike}.  }
...
\code{sushi\_table}, part of the \code{hyper2} package:
