...
\newcommand{\ld}[1]{\mu    {#1}}
\node at (6, 5)  {$\frac{\la{p_b}}{\la{p_b}+\la{p_c}+p_d+p_e}$};
\node at (6, 4)  {$\frac{\la{p_c}}{\la{p_b}+\la{p_c}+p_d+p_e}$};
\node at (6, 3)  {$\frac{p_d     }{\la{p_b}+\la{p_c}+p_d+p_e}$};
\node at (6, 2)  {$\frac{p_e     }{\la{p_b}+\la{p_c}+p_d+p_e}$};
...
\node at (7.9,5.2) {$p_d$};
\node at (7.9,4.7) {$p_e$};
\node at (9.3, 6) {$\frac{\la{p_c}}{\la{p_c}+p_d+p_e}$};
\node at (9.3, 5) {$\frac{p_d  }{\la{p_c}+p_d+p_e}$};
\node at (9.3, 4) {$\frac{p_e  }{\la{p_c}+p_d+p_e}$};

\fill (10.2, 6) circle[radius=2pt];  % abc finishes; paths de
\draw (10.2, 6) -- (11.2,7);
\node at (10.7,6.8) {$p_d$};

\node at (11.8, 7) {$\frac{p_d}{p_d+p_e}$};

\draw (10.2, 6) -- (11.2,6.2);
\node at (11.8, 6.2) {$\frac{p_e}{p_d+p_e}$};
\node at (10.7,6.3) {$p_e$};

\fill (10.2, 5) circle[radius=2pt];
\draw (10.2, 5) -- (11.2,5.3);
\node at (11.8, 5.3) {$\frac{\la{p_c}}{\la{p_c}+\ld{p_e}}$};
\node at (10.7,5.3) {$p_c$};

\draw (10.2, 5) -- (11.2,4.7);
\node at (11.8, 4.7) {$\frac{\ld{p_e}}{\la{p_c}+\ld{p_e}}$};
\node at (10.7,4.7) {$p_e$};

\fill (10.2, 4) circle[radius=2pt];
\draw (10.2, 4) -- (11.2,3.9);
\node at (11.8, 3.9) {$\frac{\la{p_c}}{\la{p_c}+\ld{p_e}}$};
\node at (10.7,4.1) {$p_c$};

\draw (10.2, 4) -- (11.2,3.1);
\node at (11.8, 3.1) {$\frac{\ld{p_e}}{\la{p_c}+\ld{p_e}}$};
\node at (10.7,3.7) {$p_e$};

\draw (4, 0) -- (5,1);
\node at (6, 1)  {$\frac{p_a}{p_a+p_b+p_c+\ld{p_e}}$};

\draw (4, 0) -- (5,0);
\node at (6, 0)  {$\frac{p_b}{p_a+p_b+p_c+\ld{p_e}}$};

\draw (4, 0) -- (5,-1);
\node at (6, -1)  {$\frac{p_c}{p_a+p_b+p_c+\ld{p_e}}$};

\draw (4, 0) -- (5,-2);
\node at (6, -2)  {$\frac{\ld{p_e}}{p_a+p_b+p_c+\ld{p_e}}$};
...
\node at (9.3, -1) {$\frac{p_a}{p_a+p_b+c}$};
\node at (9.3, -2) {$\frac{p_b}{p_a+p_b+c}$};
\node at (9.3, -3) {$\frac{p_c}{p_a+p_b+c}$};
...
\node at (11.8, 0) {$\frac{\la{p_b}}{\la{p_b}+\la{p_c}}$};
\draw (10.2, -1) -- (11.2,-1);

\node at (11.8, -1) {$\frac{\la{p_c}}{\la{p_b}+\la{p_c}}$};


\draw (10.2, -2) -- (11.2,-1.6);
\node at (11.8, -1.6) {$\frac{\la{p_a}}{\la{p_a}+\la{p_c}}$};
...
\node at (11.8, -3.4) {$\frac{\la{p_b}}{\la{p_a}+\la{p_b}}$};
...
\node at (9.3, 2) {$\frac{\la{p_b}}{\la{p_b}+\la{p_c}+p_e}$};
\node at (9.3, 1) {$\frac{\la{p_c}}{\la{p_b}+\la{p_c}+p_e}$};
\node at (9.3, 0) {$\frac{e       }{\la{p_b}+\la{p_c}+p_e}$};


\fill (10.2, 1) circle[radius=2pt];  % da finishes; paths bce
\draw (10.2, 1) -- (11.2,2);
\node at (11.8, 2) {$\frac{\la{p_b}}{\la{p_b}+\ld{p_e}}$};
\draw (10.2, 1) -- (11.2,1);
\node at (11.8, 1) {$\frac{\ld{p_e}}{\la{p_b}+p_e}$};
