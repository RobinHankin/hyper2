...
preference dataset but with modified Plackett-Luce likelihoods using
the deathorder statistic from the dataset above, and equivalence
classes comprising \skad\ and \stew, and everybody else:
