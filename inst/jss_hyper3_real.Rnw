...
complex, including features such as cooperative teamwork, within-team
communication, and real-time strategic fluidity.
...
The dataset used is the order statistic for number of deaths by each
of the five {\em Cloud9} players.  Deaths are 
