...
\fill[red] (4.8, 3) circle[radius=2pt];  % a finishes; paths bcde
\fill[red] (4.8, 2) circle[radius=2pt];  % terminal node
\fill[red] (4.8, 1) circle[radius=2pt];  % terminal node
\fill[red] (4.8, 0) circle[radius=2pt];  % d finishes; paths abce
\fill[red] (4.8,-1) circle[radius=2pt];  % terminal node

\draw (4.8,3) -- (5.8,5) -- (8.2,5);
\draw (4.8,3) -- (5.8,4) -- (8.2,4);
\draw (4.8,3) -- (5.8,3) -- (8.2,3);
\draw (4.8,3) -- (5.8,2) -- (8.2,2);
...
\fill[blue] (8.2,5) circle[radius=2pt];  % ab finishes; paths cde
\fill[blue] (8.2,4) circle[radius=2pt];  % ab finishes; paths cde
\fill[blue] (8.2,3) circle[radius=2pt];  % ab finishes; paths cde
\fill[blue] (8.2,2) circle[radius=2pt];  % ab finishes; paths cde
\draw (8.2,5) -- (8.9,6) -- (10.6,6);
\draw (8.2,5) -- (8.9,5) -- (10.6,5);
\draw (8.2,5) -- (8.9,4) -- (10.6,4);
...
\fill[green] (10.6, 6) circle[radius=2pt];  % abc finishes; paths de
\draw (10.6, 6) -- (11.2,7) -- (12.2,7);
\fill[red] (12.2,7) circle[radius=2pt];
\node at (11.8, 7.4) {$\frac{p_d}{p_d+p_e}$};

\draw (10.6, 6) -- (11.2,6.2) -- (12.2,6.2);
\fill[red] (12.2,6.2) circle[radius=2pt];
\node at (11.8, 6.6) {$\frac{p_e}{p_d+p_e}$};

\fill[green] (10.6, 5) circle[radius=2pt];
\draw (10.6, 5) -- (11.2,5.3) -- (12.2, 5.3);
\fill[red] (12.2,5.3) circle[radius=2pt];
\node at (11.8, 5.7) {$\frac{\la{p_c}}{\la{p_c}+\ld{p_e}}$};

\draw (10.6, 5) -- (11.2,4.7) -- (12.2, 4.7);
\fill[red] (12.2,4.7) circle[radius=2pt];
\node at (11.8, 5.0) {$\frac{\ld{p_e}}{\la{p_c}+\ld{p_e}}$};

\fill[green] (10.6, 4) circle[radius=2pt];
\draw (10.6, 4) -- (11.2,3.9) -- (12.2, 3.9);
\fill[red] (12.2,3.9) circle[radius=2pt];
\node at (11.8, 4.3) {$\frac{\la{p_c}}{\la{p_c}+\ld{p_e}}$};

\draw (10.6, 4) -- (11.2,3.1) -- (12.2,3.1);
\fill[red] (12.2,3.1) circle[radius=2pt];
\node at (11.8, 3.5) {$\frac{\ld{p_e}}{\la{p_c}+\ld{p_e}}$};

\draw (4.8, 0) -- (5.8,1) -- (8.2,1);
\fill[red] (12.2,1) circle[radius=2pt];

\node at (7, 1.4)  {$\frac{p_a}{p_a+p_b+p_c+\ld{p_e}}$};

\draw (4.8, 0) -- (5.8,0) -- (8.2,0);
\fill[red] (12.2,0) circle[radius=2pt];
\node at (7, 0.4)  {$\frac{p_b}{p_a+p_b+p_c+\ld{p_e}}$};

\draw (4.8, 0) -- (5.8,-1) -- (8.2,-1);
\node at (7, -0.6)  {$\frac{p_c}{p_a+p_b+p_c+\ld{p_e}}$};

\draw (4.8, 0) -- (5.8,-2) -- (8.2,-2);
\node at (7, -1.6)  {$\frac{\ld{p_e}}{p_a+p_b+p_c+\ld{p_e}}$};

\fill[blue] (8.2, -2) circle[radius=2pt];  % de finishes; paths abc
\fill[blue] (8.2, -1) circle[radius=2pt];  % de finishes; paths abc
\fill[blue] (8.2,  0) circle[radius=2pt];  % de finishes; paths abc
\draw (8.2, -2) -- (8.9,-1) -- (10.6,-1);
\draw (8.2, -2) -- (8.9,-2) -- (10.6,-2);
\draw (8.2, -2) -- (8.9,-3) -- (10.6,-3);
...
\fill[green] (10.6, -1) circle[radius=2pt];  % dea finishes; paths bc
\fill[green] (10.6, -2) circle[radius=2pt];  % deb finishes; paths ac
\fill[green] (10.6, -3) circle[radius=2pt];  % dec finishes; paths ab

\draw (10.6, -1) -- (11.2,-0) -- (12.2,0);

\node at (11.8, 0.4) {$\frac{\la{p_b}}{\la{p_b}+\la{p_c}}$};
\draw (10.6, -1) -- (11.2,-1) -- (12.2,-1);


\node at (11.8, -0.6) {$\frac{\la{p_c}}{\la{p_b}+\la{p_c}}$};


\draw(10.6, -2) -- (11.2,-1.8) -- (12.2,-1.8);
\fill[red] (12.2,-1.8) circle[radius=2pt];

\node at (11.8, -1.4) {$\frac{\la{p_a}}{\la{p_a}+\la{p_c}}$};

\draw (10.6, -2) -- (11.2,-2.6) -- (12.2,-2.6);
\fill[red] (12.2,-2.6) circle[radius=2pt];
\node at (11.8, -2.2) {$\frac{\la{p_c}}{\la{p_a}+\la{p_c}}$};


%\draw (10.6, -3) -- (11.2,-2.9);
%\fill[red] (12.2,-2.9) circle[radius=2pt];
%\node[red] at (11.8, -2.9) {$\frac{\la{p_a}}{\la{p_a}+\la{p_b}}$};

\draw (10.6, -3) -- (11.2,-3.4) -- (12.2, -3.4);
\fill[red] (12.2,-3.4) circle[radius=2pt];
\node at (11.8, -3) {$\frac{\la{p_b}}{\la{p_a}+\la{p_b}}$};

\fill[blue] (8.2, 1) circle[radius=2pt];  % da finishes; paths bce

\draw (8.2,1) -- (8.9,2) -- (10.6,2);
\draw (8.2,1) -- (8.9,1) -- (10.6,1);
\draw (8.2,1) -- (8.9,0) -- (10.6,0);
...
\fill[green] (10.6, 2) circle[radius=2pt];  % da finishes; paths bce
\fill[green] (10.6, 1) circle[radius=2pt];  % da finishes; paths bce
\fill[green] (10.6, 0) circle[radius=2pt];  % da finishes; paths bce
\draw (10.6, 1) -- (11.2,2) -- (12.2,2);
\node at (11.8, 2.4) {$\frac{\la{p_b}}{\la{p_b}+\ld{p_e}}$};
\draw (10.6, 1) -- (11.2,1) -- (12.2,1);
\node at (11.8, 1.4) {$\frac{\ld{p_e}}{\la{p_b}+p_e}$};

\end{tikzpicture}
\caption{Partial probability\label{tikzabcde} tree for five competitors
  $a$-$e$ with mutually supporting subsets $\left\lbrace a,b,c\right\rbrace$
  [with support term $\lambda$] and $(de)$ [with support term $\mu$]}
\end{center}
\end{figure}
