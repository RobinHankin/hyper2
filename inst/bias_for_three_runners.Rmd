...
biasplotter <- function(...){
    ...
    points(log(xbad), B1bad_MLE(xbad), col="black", type="l", lty=1)
    points(log(xbad), B2bad_MLE(xbad), col="red"  , type="l", lty=1)
    points(log(xbad), B3bad_MLE(xbad), col="blue" , type="l", lty=1)
    
    points(log(xbad), B1bad_naive(xbad), col="black", type="l", lty=2)
    points(log(xbad), B2bad_naive(xbad), col="red"  , type="l", lty=2)
    points(log(xbad), B3bad_naive(xbad), col="blue" , type="l", lty=2)
