...
points(log(xgood), B1good_naive(xgood), col="black",type="l",lty=2)
points(log(xgood), B2good_naive(xgood), col="red"  ,type="l",lty=2)
points(log(xgood), B3good_naive(xgood), col="blue" ,type="l",lty=2)
...
plot(log(x), M1good_MLE(x),type="n",
     ylim=c(0,3),xlim=c(log(0.1), 0),
     xlab="log(x)", ylab="MSE")
abline(v=log(cutoff),col='gray')

points(log(x), M1good_MLE(x), col="black",type="l",lty=1)
points(log(x), M2good_MLE(x), col="red",type="l",lty=1)
points(log(x), M3good_MLE(x), col="blue",type="l",lty=1)

x <- seq(from=cutoff, to=1, len=100)

points(log(x), M1bad_MLE(x), col="black",type="l",lty=1)
points(log(x), M2bad_MLE(x), col="red",type="l",lty=1)
points(log(x), M3bad_MLE(x), col="blue",type="l",lty=1)
