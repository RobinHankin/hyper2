...
points(log(x), B1bad(x), col="black", type="l", lty=2)
points(log(x), B2bad(x), col="red"  , type="l", lty=2)
points(log(x), B3bad(x), col="blue" , type="l", lty=2)

    text(-1.1, 0.1, "Naive/MLE")
    text(-1.1, 0.5, "Naive/MLE")
    text(-1.1,-0.5, "Naive/MLE")
