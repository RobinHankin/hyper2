...
for(i in seq_along(ox)){text(ox[i],oy[i],names(m)[oy[i]],pos=4,col='gray') }
...
example, using F1 points scored places Hamilton first and Vettel
second; while `hyper2` places Vettel first and Hamilton second.  But
overall there seems to be some degree of correlation between the two,
