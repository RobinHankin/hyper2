...
```{r,fouryearsdata}
F1_2014 <- "formula1_2014.txt" %>% read.table(header=TRUE) %>% ranktable2supp
F1_2015 <- "formula1_2015.txt" %>% read.table(header=TRUE) %>% ranktable2supp
F1_2016 <- "formula1_2016.txt" %>% read.table(header=TRUE) %>% ranktable2supp
F1_2017 <- "formula1_2017.txt" %>% read.table(header=TRUE) %>% ranktable2supp
