...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\author[A]{\fnms{Robin Hankin}~\snm{not sure what this is}\ead[label=e1]{hankin.robin@gmail.com}}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Addresses                                %%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\address[A]{University of Stirlling\printead[presep={\ }]{e1}.}
\end{aug}
...
\begin{supplement}
  ...
  \sdescription{
    File {\tt hankin-ejs.Rmd} is a terse rmarkdown document that
