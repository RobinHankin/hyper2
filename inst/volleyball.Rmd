...
(2010), although here only the first 52 (out of 4000) observations are
used.
...
The first row shows a game between a team comprising `p1`, `p4`, and
`p8` against a team comprising `p5` and `p6`.  Team `p1 p4 p8` won.
