...
Here I analyse a small synthetic dataset for home ground advantage, then go on to discuss
a dataset presented by Agresti.
...
```{r,label=testhomegroundadvantageAgresti,cache=TRUE}
samep.test(H,teams)
```
...
teams <- c("Miulwaukee", "Detroit", "Toronto", "New York", "Boston","Cleveland","Baltimore")
...
These cannot both be true unless $a=b$ or $\lambda=1$.  But we can, in principle,
test which one is a better model.
