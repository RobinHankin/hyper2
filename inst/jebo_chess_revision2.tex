...
in Table~\ref{kka}, \textcolor{red}{showing games played from 1981 to
  ...
  under further work below.  However, we may adopt one of two
  approaches: either we make the working assumption that the strengths
  do not change, or alternatively we wish to make inferences about the
  players' strength {\em averaged over a playing career}.  Either
  way,} Equation~\ref{likelihood_WD} becomes
...
\textcolor{red}{One strong assumption made in the
  ...
  strengths over a 36-year period.  Many sports have a career arc
