...
in Table~\ref{kka}, \textcolor{red}{showing games played from 1981 to
  ...
  the strengths do not change, or alternatively we make inferences
  about the players' strength {\em averaged over a playing career}.
  Either way,} Equation~\ref{likelihood_WD} becomes
