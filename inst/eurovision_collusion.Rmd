...
@hankin2017_rmd.  The file `eurovision2022_jury_pre_null.txt`,
used below, refers to the jury vote for the 2022 Eurovision Song
contest, pre-nullification.


First we specify the matrix as appearing in the Wikipedia page:

```{r, specifymatrix}
eurovision_table <- as.matrix(read.table("eurovision2022_juryvote_pre_null.txt",sep=","))
