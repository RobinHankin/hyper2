...
other, see Figure \ref{orderingbypointsandlikelihood}\footnote{The
...
non-first-11 drivers are placed}.  We thus see a comparison between
...
p <- formula1_points_systems()$zipf
dp2016 <- ordertable2points(as.ordertable(F1_table_2016[seq_len(top),]),p)
dp2016 <- sort(dp2016,decreasing=TRUE)
dp2016[] <- seq_along(dp2016)
m2016 <- maxp(H2016)
