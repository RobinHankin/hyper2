...
```{r,montecarlosetup, echo=FALSE, cache=FALSE}
top <- 11
...
o1 <- replicate(400,resampling(m,f2017,points=points1))
o2 <- replicate(400,resampling(m,f2017,points=points2))
o3 <- replicate(400,resampling(m,f2017,points=points3))
...
and, just for comparison, a stupid one:

```{r,cache=TRUE}
points4 <- c(1, 0,1,2,3,1,0,6,9,0,3)

o4 <- replicate(400,resampling(m,f2017,points=points4))
table(o4)
```
