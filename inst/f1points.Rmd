...
From figure \ref{orderingbypointsandlikelihood}, we see a comparison
between the two ordering systems.  Taking 2017 as an example, drivers
Hamilton and Vettel are are respectively first and second according to
both ranking ranking procedures; but R\"{a}ikk\"{o}nen YES I KNOW IT
IS WRONG: RMARKDOWN IS DEFECTIVE and Bottas are third and fourth, and
...
of agreement for the years 2016-9 would be 8,2,6, and 2 respectively.
...
zipf <- ordertable2points(ranktable_to_ordertable(wikitable_to_ranktable(F1_table_2017)),1)
...
Thus, for 2017 at least, we see that the current poionts system agrees
