...
\citep{test}.  Season ranking is based on a points allocation
...
[`samep.test()`, supplied with the package] rejects
the null that Hamilton and Vettel have the same strength in
2018 ($H_0\colon \pham= \pvet$) with a likelihood ratio of
$e^{2.76}\simeq 15.8$, corresponding (by Wilks's theorem) to an
asymptotic $p$-value of about $0.02$.
