...
and likelihood-based ranks.  There are a number of plausible points
...
generalized linear decrease $(r,r-1,r-2,\ldots,3,2,1,0)$ for fixed
integer $0<r<n$; the halving system can be generalized to a geometric
distribution; and the winner takes all system can be replaced by
giving equal points to the top $r$ competitors
...
There is no points system that is the best for all years.  However,
...
```{r,label=alottaplotsmeancorrect,echo=FALSE,fig=TRUE}
...
axis(2,at=1:4)
points(s2016[wanted,1],pch=1)
points(s2017[wanted,1],pch=2)
points(s2018[wanted,1],pch=3)
points(s2019[wanted,1],pch=4)
legend("topright",lty=0,pch=1:4,legend=c("2016","2017","2018","2019"))
```

```{r,label=alottaplotswinnercorrect,echo=FALSE,fig=TRUE}
...
axis(1,at=1:6,labels=names(formula1_points_systems(top)[wanted]))
axis(2)
points(s2016[wanted,2],pch=1)
points(s2017[wanted,2],pch=2)
points(s2018[wanted,2],pch=3)
points(s2019[wanted,2],pch=4)
legend(x=3.4,y=0.67,lty=0,pch=1:4,legend=c("2016","2017","2018","2019"))
```

```{r,label=alottaplotstotalrankorder,echo=FALSE,fig=TRUE}
...
axis(1,at=1:6,labels=names(formula1_points_systems(top)[wanted]))
axis(2)
points(s2016[wanted,3],pch=1)
points(s2017[wanted,3],pch=2)
points(s2018[wanted,3],pch=3)
points(s2019[wanted,3],pch=4)
