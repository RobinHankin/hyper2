...
We see the that the top two players, Hamilton and Vettel
of roughly equal strength and indeed a likelihood ratio test
[`samep.test()`] does not reject the null of equality ($p=0.09$).
...
m <- maxp(H)  # just 'top' players
ox <- dp
oy <- rank(-m)                           # minus as number 1 = largest strength
...
From the above, we see that the first three drivers (Hamilton, Vettel,
Bottas) are respectively first, second and third according to both
ranking procedures.
