...
We can implement this using the `uninformative` argument of
`ordertable2supp()` First, we infer from non-competing that the team
came last:
...
save(
curling_table, curling1, curling2, curling1_maxp, curling2_maxp,
file="curling.rda"
)
```
