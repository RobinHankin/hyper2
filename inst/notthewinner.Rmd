...
informative: person `1` did not win.  Package idiom is similar to the
perfectly uninformative observation considered above, except that we
remove every order that has person 1 winning:
