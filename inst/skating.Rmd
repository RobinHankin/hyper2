...
(Takes about 20 minutes to run without cache; To cite the `hyper2`
package in publications, please use @hankin2017_rmd).  This document
analyses Bradley-Terry strengths of the competitors in the Ladies'
...
and now replace ranks with internal ranks (that is, rank among the top
seven):
