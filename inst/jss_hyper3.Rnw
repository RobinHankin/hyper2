...
exceeds 4 (minimum at $p_a=\frac{1}{2}$), and the case of three
distinct runners, where the Fisher information exceeds
$\frac{1323}{16}\simeq 82.7$ (minimum at $p_a=p_b=p_c=\frac{1}{3}$); a
brief discussion is given at \code{inst/fisher\_inf\_PL3.Rmd}.
