...
Table~\ref{parkruntable} shows 7 completed parkruns.  From the first
pair of numbers we see that 43 runners from our demographic attended
that particular parkrun, of whom the author placed 37.
...
\verb{plot(table(replicate(100000,which(rrace(setNames(0.75^i,letters[1:20])) == "j"))))}
