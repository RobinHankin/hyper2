...
that particular parkrun, of whom the author placed 33.
...
\ref{requalfour}, with $b=5\times 10^4$ trials per point, we obtain
figure~\ref{doesnotexist}.  From this, we see that $s$ is less than
about XXXXXX and $x$ is between about SXXXXASDFASDFADF and WWWWW.
SDDFDSF



Recall that, in this model, $x=0.5$ implies that the Plackett-Luce
strength of each competitor is twice that of the next; and if
$x=0.25$, we can expect
...
Hamilton to be better than a randomly chosen competitor with
