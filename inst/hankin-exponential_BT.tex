...
$x=\alpha=\sqrt{(\sqrt{5}-1)/2}\simeq 0.786$ we need two distinct
estimators, one for $x\leqslant\alpha$ and one for $x>\alpha$:
...
B = \begin{cases}
2-\frac{1}{1+x}-\frac{1}{1+x^2}, & r=1, x\leqslant\alpha\\
0,                               & r=2, x\leqslant\alpha\\
\frac{1}{1+x}+\frac{1}{1+x^2}-2, & r=3, x\leqslant\alpha\\
2-\frac{2}{1+x}-\frac{2}{1+x^2}+\frac{2}{1+x+x^2},       & r=1, x>\alpha\rule{0mm}{10mm}\\
0,                                                       & r=2, x>\alpha\\
-2+\frac{2}{1+x}+\frac{2}{1+x^2}-\frac{2(1+x)}{1+x+x^2}, & r=3, x>\alpha
\end{cases}
\end{eqnarray}

\begin{eqnarray}\label{MSE}
\mathit{MSE} = \begin{cases}
  4-\frac{3}{1+x}-\frac{3}{1+x^2}+\frac{2}{1+x+x^2}                 , &r=1, x\leqslant\alpha\\
\frac{2x}{1+x+x^2}                                                  , &r=2, x\leqslant\alpha\\
 4-\frac{1}{1+x} - \frac{1}{1+x^2} -\frac{2(1+x)}{1+x+x^2}          , &r=3, x\leqslant\alpha\\
4\left(1-\frac{1}{1+x}-\frac{1}{1+x^2}+\frac{1}{1+x+x^2}\right)     , &r=1, x > \alpha\rule{0mm}{10mm}\\
1                                                                   , &r=2, x > \alpha\\
4\left(1-\frac{1}{1+x} - \frac{1}{1+x^2} +\frac{1+x}{1+x+x^2}\right), &r=3, x > \alpha\\
\end{cases}
\end{eqnarray}
...
independent Plackett-Luce races; for example the first one indicates
that competitor 2 came first, 1 came second, 4 came third, and so on.
Looking at the fourth column [headed \verb+c4+, ``came fourth''], we
see that
...
trials; as support we use $x$ running from 0.1 to 1 and $r=1,2,\ldots
9$.  Figure~\ref{toyexample} gives a visual representation of the
