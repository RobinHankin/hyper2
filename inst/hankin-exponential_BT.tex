...
We leverage the {\tt hyper2} R package~\cite{hankin2017_rnw} which
...
Above we see 15 independent Plackett-Luce races; for example the first
one indicates that competitor 2 came first, 1 came second, 4 came
third, and so on.  Looking at the fourth column [headed \verb+c4+,
  ``came fourth''], we see that
