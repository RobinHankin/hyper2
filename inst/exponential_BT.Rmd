...
plot(c(-3,0),c(-3,1),type='n', xlab="log x", ylab="support",
     main = "support for x,r", sub="Three competitors, focal competitor came FIRST"
     )
...
x <- seq(from=0.01 , to=1, by=0.01)
plot(c(-3,0),c(-3,1),type='n', xlab="log x", ylab="support",
     main = "support for x,r", sub="Three competitors, focal competitor came SECOND"
     )
...
x <- seq(from=0.01 , to=1, by=0.01)
plot(c(-3,0),c(-3,1),type='n', xlab="log x", ylab="support",
     main = "support for x,r", sub="Three competitors, focal competitor came THIRD"
     )
points(log(x),log(like(x,1)),type="l",col="black")
points(log(x),log(like(x,2)),type="l", col="red")
points(log(x),log(like(x,3)),type="l", col="blue")
