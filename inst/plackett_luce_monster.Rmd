...
* Runner $i$ might wish to support $j$.  If runner $i$ finishes, once
  ...
  other.  The causation is not symmetrical.
* Runner $i$ might hate runner $j$.  If $i$ finishes, he might expend
  his spare energy hinderig $j$ (by throwing stones, for example).
  Note that equivalence classes of mutual hatred might exist.  Again
  note that the link is not symmetrical.
