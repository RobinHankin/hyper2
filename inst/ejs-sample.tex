...
Nevertheless, it is common a student to possess some informative
observations: the total enrollment in a specific class and their
individual ranking within that class;  table~\ref{educationtable}
shows an apocryphal dataset.   What could a student infer from such
data?
...
One natural question would be to wonder whether the student was better
