...
blanks with `00`; every entry is padded to two digits.
...
Bosnia & Herzegovina (`"BH"`), who they gave rank 1 to.  Their second
favourite was Macedonia, their third was Turkey, and so on.  They were
not allowed to vote for themselves, which is why the first column is
`NA`.  So the order was: `bh`, `mc`, `tu`, `ic`, `ro`, `is`, `ar`,
`fi`, `br`, `ma`.
