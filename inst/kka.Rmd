...
(takes about 45 minutes to process without cache)
...
between players Karpov, Kasparov, and Anand.  It is used to calculate
...
`inst/kka_array.R`.  Some more detail is given in
`man/kka.Rd`.
