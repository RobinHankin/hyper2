...
for the observation of $+a\,=0\,-b$ for $p_1$ playing white and
$+c\,=0\,-d$ for $p_2$ playing white.  We then translate this into a
`hyper3` likelihood function as follows
...
$(1.4,2.9)$.  Of course, this is crude and it would be betterto have
more transparent package idiom.  But I'm working on this.

We can now introduce draws but first a change of notation.  The
previous likelihood function can be represented thus:
...
save(kka,karpov_kasparov_anand,kka_3draws,kka_3whites,kka_array,chess3,file="kka.rda")
```
