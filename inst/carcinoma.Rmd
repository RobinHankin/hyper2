...
Here, the object of inference is the set of pathologists.  Informative 
...
`DACBEGF` means that clinician `D` was most convinced of the presense
...
presence, and the others diagosed absence, of carcinoma.  The
