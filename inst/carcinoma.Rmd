...
carcinoma_count
system.time(lc <- loglik_lsl(carcinoma_count,carcinoma))
```
...
G = 0.125252494716691)
system.time(lmax <- loglik_lsl(carcinoma_maxp,carcinoma))
```


We are now in a position to compare  these three points:
