...
rank_auck    <- c(177, 222, 206, 142, 118, 224, 128, 115, 183)
runners_auck <- c(259, 305, 297, 241, 179, 338, 203, 245, 254)

rank_stir <-    c(145, 157, 156, 191, 172, 174, 173, 165, 172, 199, 181, 229)
runners_stir <- c(193, 240, 197, 257, 227, 234, 238, 238, 196, 242, 242, 318)
```
