...
text(0.07,0.95,"R=8",col=rain[8])
text(0.20,0.95,"R=7",col=rain[7])
text(0.26,0.91,"R=6",col=rain[6])
text(0.29,0.83,"R=5",col=rain[5])
text(0.33,0.76,"R=4",col=rain[4])
text(0.35,0.64,"R=3",col=rain[3])
text(0.39,0.53,"R=2",col=rain[2])
text(0.45,0.41,"R=1",col=rain[1])
}
