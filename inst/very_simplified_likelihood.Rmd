...
observation is indexed by $r$, the number of $b$'s finishing ahead of
$a$, so $0\leqslant r\leqslant n$.
...
\[
\mathcal{L}(a)=b\cdot\frac{a}{1-b}=b
\]
...
\[
\mathcal{L}(a)=\frac{b}{1}\cdot\frac{b}{1-b}\cdot\frac{a}{1-2b}=\frac{b^2}{1-2b}
\]
...
\[
\mathcal{L}(a)=b\cdot\frac{b}{1-b}\cdot\frac{b}{1-2b}\cdot\frac{a}{1-3b}=\frac{b^3}{(1-2b)(1-3b)}
\]

Fifth, four ahead:

\[
\mathcal{L}(a)=b\cdot\frac{b}{1-b}\cdot\frac{b}{1-2b}\cdot\frac{b}{1-3b}\cdot\frac{a}{1-4b}=\frac{b^4}{(1-2b)(1-3b)(1-4b)}
\]
...
\[
\mathcal{L}(b)=\frac{b^ra}{(1-b)(1-2b)\cdots(1-rb)}=\frac{b^r}{(1-2b)\cdots(1-rb)},\qquad r\geqslant 2
\]

\[
\mathcal{L}(b)=\frac{b^{r+1}}{(1-2b)\cdots(1-rb)}=\frac{(-1)^{r+1}b\Gamma(2-1/b)}{\Gamma(1+r-1/b)}
\]




The case $n=2$ was considered by Hankin 2023.
