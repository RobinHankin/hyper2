...
optimize(function(a){f_vec_arn(a,rank[wp],class_size[wp])},c(0.3,0.6),maximum=TRUE)
optimize(function(a){f_vec_arn(a,rank[wa],class_size[wa])},c(0.3,0.6),maximum=TRUE)
```
