...
suggestion~\cite{burgess2020,ho2021} is that Brazilian surfers tend to
have skillsets that favour point and beach break wave types, readily
accessible to these surfers' native Brazil; see~\cite{scarfe2003} for
a scientific overview of surf break characteristics,
and~\cite{butt2004} for a surfer's perspective.
