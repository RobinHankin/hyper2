...
If "won" means "came last" we would have $a\succ b\succ a\succ a$,
with PL likelihood function
...
Now if we define "won" to be noninformative the order statistic is
simply $a \succ b\succ a$, with PL likelihood function
