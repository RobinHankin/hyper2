...
make_obs <- function(no_of_observations, no_of_competitors, r_true, x_true){
    kk <- makeracetable(no_of_races = no_of_observations, no_of_competitors = no_of_competitors, x_true = x_true)
...
```{r executemax1, cache=TRUE}
#makemaxliketable(100, 10, allX9, r_true = 5, x_true = 0.7)
#makemaxliketable(100, 20, allX9, r_true = 5, x_true = 0.7)
```

```{r execu, cache=TRUE}
makemaxliketable(            n=100, nobs=10, no_of_competitors=9, allX=allX9, r_true = 4, x_true = 0.7)
#makemaxliketable(100, 20, allX9, r_true = 1, x_true = 0.7)
#makemaxliketable(100,100, allX9, r_true = 1, x_true = 0.7)
```