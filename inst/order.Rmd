...
multiplicative constant].  And in this case, the evaluate
$(1,0,\ldots,0)$ is not a hypothesis anyone would want a likelihood
for: the likelihood is not defined at that point, and does not even
