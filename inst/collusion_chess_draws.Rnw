...
\end{tabular}\quad
\begin{tabular}{@{} *{4}{c} @{}}
\headercell{\small{Plays W,}\\ \small{loses}} & \multicolumn{3}{c@{}}{\small{Plays white, loses}}\\
\cmidrule(l){2-4}
& An &  Kr & Ks        \\ 
\midrule
  An & -  &  13 &   2  \\
  ...
  Ks & 11 &   9 &  -   \\
\end{tabular}
\caption{Results of 365 chess matches \label{kka} between three
  Grandmasters.  Thus, for example, Anand played white against Karpov
  a total of $18+20+13=51$ times and won 18, drew 20, lost 13}
\end{table}
