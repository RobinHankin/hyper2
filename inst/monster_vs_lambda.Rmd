...
subtitle: "Takes about an hour to run without cache"
author: "R. K. S. Hankin"
...
$A$ and $\lambda$ does not appear to have a simple analytical
solution; we must proceed numerically.  To do so, we need to define a
